    ...
    <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
            <div class="text-center">
                <img class="mb-10" src="<c:url value='/static/imgs/template/favicon.svg'/>" alt="Ecom">
    ...
    <div class="container-topbar">
        <div class="menu-topbar-left d-none d-xl-block">
            <ul class="nav-small">
                ...
                <li><a class="font-xs" href="<c:url value='/register-shop'/>"><fmt:message key="header.topbar.openshop"/></a></li>
            </ul>
        </div>
            ...
            <div class="dropdown dropdown-language">
                <button class="btn dropdown-toggle" id="dropdownPage" type="button" data-bs-toggle="dropdown" aria-expanded="true" data-bs-display="static">
                    <span class="dropdown-right font-xs color-brand-3">
                        <img src="<c:url value='/static/imgs/template/en.svg'/>" alt="Ecom"> English
                    </span>
                </button>
                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownPage" data-bs-popper="static">
                    <li><a class="dropdown-item" href="#"><img src="<c:url value='/static/imgs/template/flag-en.svg'/>" alt="Ecom"> English</a></li>
                    <li><a class="dropdown-item" href="#"><img src="<c:url value='/static/imgs/template/flag-fr.svg'/>" alt="Ecom"> Français</a></li>
                    <li><a class="dropdown-item" href="#"><img src="<c:url value='/static/imgs/template/flag-es.svg'/>" alt="Ecom"> Español</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="header-left">
                ...
                <div class="header-logo">
                    <a class="d-flex" href="<c:url value='/'/>">
                        <img alt="Ecom" src="<c:url value='/static/imgs/template/logo.svg'/>">
                    </a>
                </div>
                ...
                <div class="header-search">
                    <div class="box-header-search">
                        <form class="form-search" method="get" action="<c:url value='/search'/>">
                            <div class="box-category">
                                <select class="select-active select2-hidden-accessible">
                                    <option><fmt:message key="header.search.category.all"/></option>
                                    <option value="Computers">Computers</option>
                                    <option value="Phones">Cell Phones</option>
                                </select>
                            </div>
                            <div class="box-keysearch">
                                <input class="form-control font-xs" type="text" name="q" placeholder="<fmt:message key='header.search.placeholder'/>">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="header-nav">
                    <nav class="nav-main-menu d-none d-xl-block">
                        <ul class="main-menu">
                            ...
                            <li><a href="<c:url value='/shop'/>"><fmt:message key="menu.shop"/></a></li>
                ...
                <div class="header-shop">
                    <div class="d-inline-block box-dropdown-cart">
                        ...
                        <span class="font-lg icon-list icon-cart">
                            <span>Cart</span><span class="number-item font-xs">2</span>
                        </span>
                                <div class="dropdown-cart">
                                    <!-- Cart Items (Ví dụ tĩnh) -->
                                    <div class="item-cart mb-20">
                                        <div class="cart-image">
                                            <img src="<c:url value='/static/imgs/page/homepage1/imgsp5.png'/>" alt="Ecom">
                                        </div>
                                        <div class="cart-info">
                                            <a class="font-sm-bold color-brand-3" href="#">iMac 5K</a>
                                    ...
                                    <div class="cart-total">
                                        <div class="row mt-15">
                                            <div class="col-6 text-start">
                                                <a class="btn btn-cart w-auto" href="<c:url value='/cart'/>">View cart</a>
                                            </div>
                                            <div class="col-6">
                                                <a class="btn btn-buy w-auto" href="<c:url value='/checkout'/>">Checkout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mobile-header-top">
                            <div class="user-account">
                                <a href="<c:url value='/account/profile'/>">
                                    <img src="<c:url value='/static/imgs/template/ava_1.png'/>" alt="User">
                                </a>
                                <div class="content">
                                    <h6 class="user-name">
