    ...
    <div class="col-nav">
        ...
        <ul class="nav">
            <li class="nav-item">
                ...
                ><span class="badge rounded-pill">3</span></a
                >
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="requestfullscreen nav-link btn-icon" href="#"
            ...
            <li class="dropdown nav-item">
                ...
                >
                    ...
                    ><img
                            src="<c:url value="/static/admin/imgs/theme/flag-us.png"/>"
                            alt="English"
                    />English</a
                    ><a class="dropdown-item" href="#"
                ><img
                        src="<c:url value="/static/admin/imgs/theme/flag-fr.png"/>"
                        alt="Français"
                />Fran&ccedil;ais</a
                ><a class="dropdown-item" href="#"
                ><img
                        src="<c:url value="/static/admin/imgs/theme/flag-jp.png"/>"
                        alt="Français"
                />&#x65E5;&#x672C;&#x8A9E;</a
                ><a class="dropdown-item" href="#"
                ><img
                        src="<c:url value="/static/admin/imgs/theme/flag-cn.png"/>"
                        alt="Français"
                />&#x4E2D;&#x56FD;&#x4EBA;</a
                >
                </div>
            ...
            <li class="dropdown nav-item">
                ...
                ><img
                        ...
                        src="<c:url value="/static/admin/imgs/people/avatar2.jpg"/>"
                        alt="User"
                /></a>
                <div
                        class="dropdown-menu dropdown-menu-end"
